...
function SpellActivationOverlay_OnLoad(self)
	OVERLAY.Frame = self;
	OVERLAY.ShowAllOverlays = SpellActivationOverlay_ShowAllOverlays;
	OVERLAY.HideOverlays = SpellActivationOverlay_HideOverlays;
	OVERLAY.HideAllOverlays = SpellActivationOverlay_HideAllOverlays;
