...
-- @param auraID name of the aura registered to OVERLAY.RegisterAura
-- @param talent talent object { tab, index } to check when counter triggers; may be nil
function OVERLAY.RegisterCounter(self, auraID, talent)
...
function OVERLAY.CheckCounterAction(self, spellID, auraID, talent)
    if (talent) then
...
function OVERLAY.CheckAllCounterActions(self)
